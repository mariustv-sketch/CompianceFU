...
export default function NewJobScreen() {
  ...
  async function save() {
    ...
    setSaving(true);
    try {
      await api.createJob({ name: name.trim(), description: description.trim(), tasks });
      router.back();
    } catch {
      Alert.alert('Feil', 'Kunne ikke opprette jobb');
    } finally {
      setSaving(false);
    }
  }
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              placeholder="F.eks. Kabelpåvisning"
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              placeholder="Valgfri beskrivelse av jobben"
              placeholderTextColor={COLORS.textMuted}
              multiline
              numberOfLines={3}
            />
        ...
        <View style={styles.footer}>
          ...
          >
            {saving ? (
              ...
              <Text style={styles.saveBtnText}>Opprett jobb</Text>
            )}
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
